...
print '[[ Preparing Source Distribution for Reggie! Mod ]]'
...
shutil.copy('reggie_mod_light.py', dir)
shutil.copy('reggie_mod_dark.py', dir)
...
shutil.copy('windows_build_dark.py', dir)
shutil.copy('linux_build.py', dir)
shutil.copy('linux_build_dark.py', dir)
